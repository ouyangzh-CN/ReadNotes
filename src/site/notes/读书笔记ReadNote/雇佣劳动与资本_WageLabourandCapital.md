---
{"dg-publish":true,"permalink":"/read-note/wage-labourand-capital/","tags":["gardenEntry"]}
---
...
2. ==那么商品的价格是什么决定的？==：
	...
	2. 价格由==生产费用==决定 = 价格由生产商品所必须的劳动**时间**决定（见序言[[读书笔记ReadNote/雇佣劳动与资本_WageLabourandCapital#^d1d3e7\|雇佣劳动与资本_WageLabourandCapital#^d1d3e7]]） 
		1. 生产费用的组成部分
